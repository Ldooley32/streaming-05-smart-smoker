...
if not output_csv_path.exists():
    with open(output_csv_path, mode='w', newline='') as file:
        ...
        writer.writerow(["Food B Temp"])

# Define a deque to keep track of temperatures for Food Stall
FoodB_temps = deque(maxlen=20)  # For 10 minutes of data (20 * 30 seconds)
...
def main(hn: str = "localhost", qn: str = "temp_queue2"):
